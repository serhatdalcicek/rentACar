...
public class CarRentalsController {
    ...
    public Result delete(@RequestBody  DeleteCarRentalRequest deleteCarRentalRequest) {
    ...
    public Result returnRental(@RequestBody ReturnCarRentalRequest returnCarRentalRequest) {
        return this.carRentalService.ReturnCarRental(returnCarRentalRequest);
    }
    /*
